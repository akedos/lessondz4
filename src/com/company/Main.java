...
public class Main {
    ...
    public static String[] heroesAttackType = {
            "Physical", "Kinetic", "Magic", "Medic", "Golem"};
    ...
    public static void medic() {
        ...
        if (heroesHealth[randomHero] > 0 && heroesHealth[3] > 0 && heroesHealth[randomHero] < 100){
            heroesHealth[randomHero] +=50;
            System.out.println(heroesAttackType[randomHero] +" healed");
        }
